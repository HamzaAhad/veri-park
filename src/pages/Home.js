      ...
      <main>
        <div className="hero__container">
          <div className="hero__content">
            ...
            >
              Veri Park is a clothing brand that offers a wide range of clothing
              items from multiple brands, all under one roof.Veri Park's mission
              is to provide customers with a one-stop-shop for all their
              clothing needs, catering to various styles, preferences, and
              budgets.Veri Park prides itself on offering high-quality and
              stylish clothing from a diverse range of brands. Whether you're
              looking for casual wear, formal wear, sportswear, or something in
              between,Veri Park has got you covered. From popular international
              brands to local designers,Veri Park's collection is extensive, and
              you are sure to find something that suits your taste and style.
            </p>
